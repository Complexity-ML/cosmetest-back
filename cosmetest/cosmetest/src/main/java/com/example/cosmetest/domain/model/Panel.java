...
@Table(name = "panel", indexes = @Index(name = "idx_id_etude", columnList = "idEtude"))
public class Panel implements java.io.Serializable {
	...
	// Sécheresse fields - probably severity levels
	@Column(length = 20)
	...
	public Panel(int idEtude, int idGroupe) {
		this.idEtude = idEtude;
		this.idGroupe = idGroupe;
	}

	public Panel(int idEtude, int idGroupe, String sexe, String carnation, String bronzage, String coupsDeSoleil,
			String expositionSolaire, String phototype, String sensibiliteCutanee, String typePeauVisage,
			String secheresseLevres, String secheresseCou, String secheressePoitrineDecollete,
			String secheresseVentreTaille, String secheresseFessesHanches, String secheresseBras,
			String secheresseMains, String secheresseJambes, String secheressePieds, String tachesPigmentairesVisage,
			String tachesPigmentairesCou, String tachesPigmentairesDecollete, String tachesPigmentairesMains,
			String perteDeFermeteVisage, String perteDeFermeteCou, String perteDeFermeteDecollete, String pilosite,
			String cicatrices, String tatouages, String piercings, String vergeturesJambes,
			String vergeturesFessesHanches, String vergeturesVentreTaille, String vergeturesPoitrineDecollete,
			String celluliteJambes, String celluliteFessesHanches, String celluliteVentreTaille, String celluliteBras,
			...
			String contraception, String acne, String couperoseRosacee, String psoriasis, String dermiteSeborrheique,
			String eczema, String angiome, String pityriasis, String vitiligo, String melanome, String zona,
			String herpes, String pelade, String reactionAllergique, String desensibilisation, String terrainAtopique,
			String scorePodMin, String scorePogMin, String scoreFrontMin, String scoreLionMin, String scorePpdMin,
			String scorePpgMin, String scoreDodMin, String scoreDogMin, String scoreSngdMin, String scoreSnggMin,
			String scoreLevsupMin, String scoreComlevdMin, String scoreComlevgMin, String scorePtoseMin,
			String originePere, String origineMere, String bouffeeChaleurMenaupose, String sousEthnie,
			String scorePodMax, String scorePogMax, String scoreFrontMax, String scorePpdMax, String scoreDodMax,
			String scoreDogMax, String scoreSngdMax, String scoreSnggMax, String scoreLevsupMax, String scoreComlevdMax,
			String scoreComlevgMax, String scorePtoseMax, String scoreLionMax, String scorePpgMax, String yeux,
			String levres, String cernesVasculaires, String mapyeux, String maplevres, String mapsourcils) {
		this.idEtude = idEtude;
		this.idGroupe = idGroupe;
		this.sexe = sexe;
