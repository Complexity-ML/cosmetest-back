...
public class VolontaireMapper {
    ...
    public VolontaireDetailDTO toDetailDTO(Volontaire volontaire) {
        ...
        // Critères d'étude
        dto.setTenueLevres(volontaire.getTenueLevres());
        dto.setTenueTeint(volontaire.getTenueTeint());
        dto.setTenueBlush(volontaire.getTenueBlush());
        dto.setTenueSourcil(volontaire.getTenueSourcil());
        dto.setTenueLiner(volontaire.getTenueLiner());
        dto.setDemaquillant(volontaire.getDemaquillant());
        dto.setEtudeCils(volontaire.getEtudeCils());
        dto.setCorneoLevre(volontaire.getCorneoLevre());
        dto.setCorneoBras(volontaire.getCorneoBras());
        dto.setDtm(volontaire.getDtm());
    ...
    public Volontaire toEntity(VolontaireDetailDTO dto) {
        ...
        // Critères d'étude
        volontaire.setTenueLevres(dto.getTenueLevres());
        volontaire.setTenueTeint(dto.getTenueTeint());
        volontaire.setTenueBlush(dto.getTenueBlush());
        volontaire.setTenueSourcil(dto.getTenueSourcil());
        volontaire.setTenueLiner(dto.getTenueLiner());
        volontaire.setDemaquillant(dto.getDemaquillant());
        volontaire.setEtudeCils(dto.getEtudeCils());
        volontaire.setCorneoLevre(dto.getCorneoLevre());
        volontaire.setCorneoBras(dto.getCorneoBras());
        volontaire.setDtm(dto.getDtm());
    ...
    public Volontaire updateEntityFromDetailDTO(Volontaire entity, VolontaireDetailDTO dto) {
        ...
        // Critères d'étude
        if (dto.getTenueLevres() != null)
            entity.setTenueLevres(dto.getTenueLevres());
        if (dto.getTenueTeint() != null)
            entity.setTenueTeint(dto.getTenueTeint());
        if (dto.getTenueBlush() != null)
            entity.setTenueBlush(dto.getTenueBlush());
        if (dto.getTenueSourcil() != null)
            entity.setTenueSourcil(dto.getTenueSourcil());
        if (dto.getTenueLiner() != null)
            entity.setTenueLiner(dto.getTenueLiner());
        if (dto.getDemaquillant() != null)
            entity.setDemaquillant(dto.getDemaquillant());
        if (dto.getEtudeCils() != null)
            entity.setEtudeCils(dto.getEtudeCils());
        if (dto.getCorneoLevre() != null)
            entity.setCorneoLevre(dto.getCorneoLevre());
        if (dto.getCorneoBras() != null)
            entity.setCorneoBras(dto.getCorneoBras());
        if (dto.getDtm() != null)
