...
public class Volontaire implements java.io.Serializable {
	...
	@Column(name = "DATE_FIN_STANDBY")
	private String dateFinStandby;
	...
	// Critères d'étude (booléens Oui/Non, défaut Oui)
	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String tenueLevres = "Oui";

	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String tenueTeint = "Oui";

	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String tenueBlush = "Oui";

	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String tenueSourcil = "Oui";

	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String tenueLiner = "Oui";

	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String demaquillant = "Oui";

	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String etudeCils = "Oui";

	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String corneoLevre = "Oui";

	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String corneoBras = "Oui";

	@Column(length = 5, columnDefinition = "VARCHAR(5) DEFAULT 'Oui'")
	private String dtm = "Oui";
	...
	@PostLoad
	private void setDefaultCriteresEtude() {
		if (tenueLevres == null) tenueLevres = "Oui";
		if (tenueTeint == null) tenueTeint = "Oui";
		if (tenueBlush == null) tenueBlush = "Oui";
		if (tenueSourcil == null) tenueSourcil = "Oui";
		if (tenueLiner == null) tenueLiner = "Oui";
		if (demaquillant == null) demaquillant = "Oui";
		if (etudeCils == null) etudeCils = "Oui";
		if (corneoLevre == null) corneoLevre = "Oui";
		if (corneoBras == null) corneoBras = "Oui";
		if (dtm == null) dtm = "Oui";
	}
	...
	public String getDateFinStandby() {
		return this.dateFinStandby;
	}

	public void setDateFinStandby(String dateFinStandby) {
		this.dateFinStandby = dateFinStandby;
	}
	...
	public String getTenueLevres() { return tenueLevres; }
	public void setTenueLevres(String tenueLevres) { this.tenueLevres = tenueLevres; }

	public String getTenueTeint() { return tenueTeint; }
	public void setTenueTeint(String tenueTeint) { this.tenueTeint = tenueTeint; }

	public String getTenueBlush() { return tenueBlush; }
	public void setTenueBlush(String tenueBlush) { this.tenueBlush = tenueBlush; }

	public String getTenueSourcil() { return tenueSourcil; }
	public void setTenueSourcil(String tenueSourcil) { this.tenueSourcil = tenueSourcil; }

	public String getTenueLiner() { return tenueLiner; }
	public void setTenueLiner(String tenueLiner) { this.tenueLiner = tenueLiner; }

	public String getDemaquillant() { return demaquillant; }
	public void setDemaquillant(String demaquillant) { this.demaquillant = demaquillant; }

	public String getEtudeCils() { return etudeCils; }
	public void setEtudeCils(String etudeCils) { this.etudeCils = etudeCils; }

	public String getCorneoLevre() { return corneoLevre; }
	public void setCorneoLevre(String corneoLevre) { this.corneoLevre = corneoLevre; }

	public String getCorneoBras() { return corneoBras; }
	public void setCorneoBras(String corneoBras) { this.corneoBras = corneoBras; }

	public String getDtm() { return dtm; }
	public void setDtm(String dtm) { this.dtm = dtm; }
